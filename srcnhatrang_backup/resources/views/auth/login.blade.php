            ...
            <form method="POST" action="{{ route('login') }}" class="sm:w-2/3 w-full px-4 xl:px-0 mx-auto">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="flex">
                            <input type="password" name="password" id="password" class="bg-gray-50 border border-gray-300 text-sm rounded-s-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Nhập mật khẩu" required="">
                            <span class="inline-flex items-center px-3 text-sm bg-gray-200 border border-e-0 border-gray-300 rounded-e-lg dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                    ...
                    <button type="submit" class="col-span-2 text-white font-medium block w-full p-2 text-base rounded-full bg-primary-500 hover:bg-primary-600 focus:outline-none">Đăng nhập</button>            
                </div>
