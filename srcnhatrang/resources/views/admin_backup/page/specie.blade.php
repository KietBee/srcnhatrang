            ...
            <table class="w-full text-sm text-left rtl:text-right">
                <thead class="text-xs  uppercase bg-white border-b border-gray-200">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">
                            <a href="{{ route('admin.specie', ['orderBy' => 'specie_name', 'orderDirection' => 'desc']) }}">Sắp xếp theo tên</a>
                        </th>
                        <th scope="col" class="px-6 py-3">
                            <a href="{{ route('admin.specie', ['orderBy' => 'breed_count', 'orderDirection' => 'desc']) }}">Sắp xếp theo tên</a>
                        </th>
                        <th scope="col" class="px-6 py-3">
                            Ngày tạo
                        </th>
                ...
                <tbody class="field-value">
                    @foreach($listSpecie as $specie)
                    <tr class="bg-white border-b border-gray-200 hover:bg-gray-200">
                        <td class="px-6 py-4">{{ $specie->specie_id }}</td>
                        <td class="px-6 py-4">{{ $specie->specie_name }}</td>
                        <td class="px-6 py-4">
                            {{ $specie->breed_count }}
                        </td>
                        <td class="px-6 py-4">{{ $specie->created_at }}</td>
                        <td class="px-6 py-4">{{ $specie->updated_at }}</td>
