    ...
    <div class="xl:w-1/2 w-full flex items-center justify-center md:px-16 px-0 z-0 bg-white dark:bg-gray-800">
        ...
        <div class="w-full py-6 z-20">
            <a id="header-logo" href="{{ route('home') }}" class="mb-8 flex justify-center">
                <img class="down_xl:hidden dark:hidden" src="{{ asset('storage/images/app/home/header/logo-green.svg') }}" alt="" width="80" height="80" >
                <img class="xl:hidden dark:block" src="{{ asset('storage/images/app/home/header/logo-dashboard.svg') }}" alt="" width="80" height="80" >
              </a>       
            <form method="POST" action="{{ route('password.store') }}" class="sm:w-2/3 w-full px-4 xl:px-0 mx-auto">
                @csrf
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                      ...
                      <input type="email" name="email" id="email" value="{{ old('email', $request->email) }}" required autocomplete="username" readonly class="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="example.@gmail.com" required="">
                    ...
                    <div class="col-span-2" x-data="{ show: true }"> 
                        ...
                        <div class="relative">
                            <input name="password" id="password" autofocus placeholder="Nhập mật khẩu" required="" :type="show ? 'password' : 'text'" class="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                      ...
                      <div class="col-span-2" x-data="{ show: true }"> 
                        ...
                        <div class="relative">
                            <input name="password_confirmation" id="password_confirmation" placeholder="Nhập mật khẩu" required="" :type="show ? 'password' : 'text'" class="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-xs leading-5">
                    ...
                    <button type="submit" class="col-span-2 text-white font-medium block w-full p-2 text-base rounded-full bg-primary-100 hover:bg-primary-900 focus:outline-none">Đặt lại mật khẩu</button>            
                </div>
