    ...
    <section class="min-h-screen flex items-stretch down_xl:text-white dark:text-white">
        ...
        <div class="xl:w-1/2 w-full flex items-center justify-center md:px-16 px-0 z-0 bg-white dark:bg-gray-800">
            ...
            <div class="w-full py-6 z-20">
                ...
                <form method="POST" action="{{ route('login') }}" class="sm:w-2/3 w-full px-4 xl:px-0 mx-auto">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2" x-data="{ show: true }">
                            ...
                            <div class="relative">
                                <input name="password" id="password" placeholder="Nhập mật khẩu" required=""
                        ...
                        <button type="submit"
                            class="col-span-2 text-white font-medium block w-full p-2 text-base rounded-full bg-primary-500 hover:bg-primary-600 focus:outline-none">Đăng
                            nhập</button>
                    </div>

                    <p class="text-sm mt-6 text-center">Bạn chưa có tài khoản? <a href="{{ route('register') }}"
                            class="text-blue-600 font-semibold hover:underline ml-1">Đăng ký ngay</a></p>
