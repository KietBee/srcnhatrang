...
<section class="min-h-screen flex items-stretch down_xl:text-white dark:text-white">
    <div class="xl:flex xl:w-1/2 down_xl:hidden relative items-center text-white">
        ...
        <div class="w-full px-24 z-10">
            <h1 class="text-5xl font-bold text-left tracking-wide">Đừng lo lắng</h1>
            <p class="text-3xl my-4">Chúng tôi sẽ cung cấp link khôi phục mật khẩu mới qua địa chỉ email của bạn.</p>
        </div>
    ...
    <div class="xl:w-1/2 w-full flex items-center justify-center md:px-16 px-0 z-0 bg-white dark:bg-gray-800">
        ...
        <div class="w-full py-6 z-20">
            ...
            <form method="POST" action="{{ route('password.email') }}" class="sm:w-2/3 w-full px-4 xl:px-0 mx-auto">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <div class="mb-4 text-sm text-white">
                            {{ __('Quên mật khẩu? Không sao. Hãy cho chúng tôi biết địa chỉ email của bạn và chúng tôi sẽ gửi một liên kết để đặt lại mật khẩu qua email, cho phép bạn chọn một mật khẩu mới.') }}
                    ...
                    <button type="submit" class="col-span-2 text-white font-medium block w-full p-2 text-base rounded-full bg-primary-100 hover:bg-primary-900 focus:outline-none">{{ __('Gửi liên kết đặt lại mật khẩu') }}</button>            
                </div>
