        ...
        <div class="container">
            <div class="flex justify-between mb-10">
                ...
                <a href="{{ $content['linkAll']['url'] }}"
                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-primary-100 rounded-lg hover:bg-primary-900 focus:ring-4 focus:outline-none focus:ring-blue-300 anima-right">
