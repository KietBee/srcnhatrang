    ...
    @else
        @forelse($paginator->items() as $item)
            ...
            >
                @if($this->canSelect())
                    <td class="p-0"
                        x-bind:class="bg-neutral-100 group-odd:bg-white group-hover:bg-neutral-200 dark:bg-neutral-800 dark:group-odd:bg-neutral-900 dark:group-hover:bg-neutral-700">
                        <div class="mx-3">
                ...
                @foreach($table['columns'] as $column)
                    @continue(! in_array($column->code(), $this->columns))
                    <td class="p-0 bg-neutral-100 group-odd:bg-white group-hover:bg-neutral-200 dark:bg-neutral-800 dark:group-odd:bg-neutral-900 dark:group-hover:bg-neutral-700">
                        {{ $column->render($item) }}
                    </td>
                @endforeach
            </tr>
