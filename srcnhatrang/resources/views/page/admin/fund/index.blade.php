...
@section('content')
<section id="admin-fund" class="bg-gray-50 dark:bg-gray-900 py-3 sm:py-5">
    ...
    <div class="mx-auto">
        <div class="w-full py-4 flex flex-shrink-0">
            <x-admin.modal-create buttonName="Thêm quỹ mới" route="{{ route('admin.fund.create') }}">
                <div class="mb-6 col-span-2">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900">Tiêu đề</label>
                    <input type="text" id="title" name="title"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="Nhập tiêu đề quỹ" required />
                </div>
                <div class="mb-6 col-span-2">
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Nội dung</label>
                    <textarea id="description" rows="4" name="description"
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Nhập nội dung quỹ..." required></textarea>
                </div>
                ...
                <div class="mb-6 col-span-2">
                    ...
                    <input
                        ...
                        aria-describedby="file_input_help" id="file_input" type="file" name="feature_image" required>
