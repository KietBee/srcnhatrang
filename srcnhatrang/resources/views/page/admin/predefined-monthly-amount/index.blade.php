...
<section id="admin-predefined-monthly-amount" class="bg-gray-50 dark:bg-gray-900 py-3 sm:py-5">
    ...
    <div class="mx-auto">
        <div class="w-full py-4 flex flex-shrink-0">
            <x-admin.modal-create buttonName="Thêm giá tiền quyên góp mặc định" route="{{ route('admin.predefined-monthly-amount.create') }}">
    ...
    <livewire:predefined-monthly-amount-table/>
</section>
@endsection
