        ...
        return [
            ...
            SelectColumn::make(__('Trạng thái kiểm duyệt'), 'is_approval')
                ...
                ->displayUsing(function ($value, $model) {
                    ...
                    '<a href="'.route('admin.pet-adoption-request.edit', ['id' => $model->getKey()]).'" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Chờ kiểm duyệt</a>';
                })                
                ->sortable()
                ->searchable()
                ->asHtml(),   
