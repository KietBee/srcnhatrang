...
class PredefinedOnlyAmountTable extends LivewireTable
{
    protected string $model = PredefinedOnlyAmount::class;
    ...
    protected function columns(): array
    {
        return [
            ...
            Column::make(__('Tùy chọn'), function (Model $model): string {
                $editUrl = route('admin.predefined-only-amount.edit', ['id' => $model->getKey()]);
